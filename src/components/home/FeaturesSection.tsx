...
export const FeaturesSection = () => {
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      {/* Gradient accents */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-150 h-150 bg-primary/10 rounded-full blur-3xl" />
      ...
      <div className="container mx-auto px-4 lg:px-8 relative">
        ...
        >
          <span className="inline-block px-4 py-2 rounded-full glass-panel text-sm font-medium text-neon-cyan mb-4">
            Why Code Mitra?
          </span>
          ...
          <p className="text-muted-foreground text-lg">
            We've designed our platform with your success in mind, providing all the tools and support you need.
          </p>
        </motion.div>
        ...
        >
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="glass-panel p-6 h-full card-hover border-border/30 hover:border-primary/30">
                {/* Icon */}
